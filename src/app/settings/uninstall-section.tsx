...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this candidate desktop app. One Person Lab core, your config, and chats stay.',
    consequence: 'the One Person Lab candidate desktop app and its local app data',
    needsAgent: false
  },
  {
    mode: 'lite',
    title: 'Uninstall app + local core, keep my data',
    description: 'Remove the app and local One Person Lab core, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the One Person Lab candidate app and local core (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    title: 'Uninstall everything',
    description: 'Remove the app, local core, and all user data — config, chats, scheduled jobs, secrets, logs.',
    consequence: 'EVERYTHING — the One Person Lab candidate app, local core, and all of your config, chats, secrets, and logs',
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall One Person Lab Hermes Candidate</p>

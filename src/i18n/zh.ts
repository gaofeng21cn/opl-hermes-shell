...
export const zh: Translations = {
  ...
  boot: {
    ...
    errors: {
      ...
      gatewayReconnectFailed: '已失去与 One Person Lab 网关的连接，且无法重新连接。',
  ...
  settings: {
    ...
    about: {
      ...
      automaticUpdatesDesc: 'One Person Lab 会在后台检查此候选壳更新，并在有可用更新时通知你。',
    ...
    mcp: {
      ...
      diagnosticTitle: 'MCP 诊断',
      diagnosticDesc: '查看候选适配层保存的 MCP 配置。默认 chat-first 和 OPL Skill 调用不需要手工管理 MCP。',
      openDiagnostics: '打开诊断',
      reloadedTitle: 'MCP 配置已检查',
      reloadedMessage: '候选适配层已读取当前 MCP 配置；实际 MCP 生命周期由 Codex 在后续回合或新会话中接管。',
      reloadFailed: 'MCP 配置检查失败',
      savedTitle: 'MCP 服务器已保存',
      savedMessage: name => `${name} 已保存到候选适配层配置；Codex 会在后续回合或新会话中按需读取。`,
      newServer: '新服务器',
      reload: '检查 MCP 配置',
      reloading: '检查中...',
  ...
  commandCenter: {
    ...
    mcpServers: 'MCP 服务器',
    archivedChats: '已归档对话',
    sections: { sessions: '会话', system: '诊断' },
    sectionDescriptions: {
      sessions: '搜索与管理会话',
      system: '适配器状态与最近日志'
    },
    ...
    sectionEntries: {
      ...
      system: { title: '诊断面板', detail: '网关状态与日志' }
    },
    providerNavigate: '导航',
    providerSessions: '会话',
    refresh: '刷新',
    ...
    deleteSession: '删除会话',
    noSessions: '暂无会话。',
    gatewayRunning: 'Codex 适配器运行中',
    gatewayStopped: 'Codex 适配器已停止',
  ...
  install: {
    ...
    cancelling: '正在进入...',
    cancelInstall: '取消初始化',
    skipInstallHint: '如果 Codex 已可用，可以先进入对话。One Person Lab 模块检查会稍后在设置与诊断中继续。',
    skipToChat: '跳过并进入对话',

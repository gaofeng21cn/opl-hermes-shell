...
export function getOplCodexSkills(): Promise<OplCodexSkillCatalog> {
  return window.hermesDesktop.api<OplCodexSkillCatalog>({
    ...profileScoped(),
    path: '/api/opl/codex-skills'
  })
}
